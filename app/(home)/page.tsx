// Components
import { DrawingTools } from "@/components/HomeDrawing/Index";
  ...
  return (
    <>
      <main className="min-h-screen flex flex-col items-center justify-center text-center pt-20">
        <h1 className="text-7xl font-bold rainbow-text select-none pointer-events-none pb-6 z-20">
          WEDRAW
        </h1>
        ...
        <div className="absolute bottom-4">
          <span className="font-semibold select-none relative z-20">
            Made By
          </span>
          <span className="font-bold rainbow-text select-none relative z-20">
            {" "}
            Lucas Maciel
          </span>
        </div>
